...
import {
  ...
  LogOut, Home, ShieldCheck, BarChart3,
} from 'lucide-react';
...
const AdminLayout = () => {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50 dark:bg-gray-900">
      <aside className="w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 fixed h-full overflow-y-auto flex flex-col">
        <div className="p-4 border-b border-gray-200 dark:border-gray-700">
          <h1 className="text-xl font-bold text-purple-600">DocMind Admin</h1>
          <p className="text-xs text-gray-500 dark:text-gray-400">Admin Panel</p>
        </div>
        <nav className="p-4 space-y-1 flex-1">
          <AdminNavItem to="/admin" icon={<LayoutDashboard size={18} />} label="Dashboard" active={isActive('/admin') && location.pathname === '/admin'} />
          ...
          <AdminNavItem to="/admin/analytics" icon={<BarChart3 size={18} />} label="Analytics" active={isActive('/admin/analytics')} />
          <AdminNavItem to="/admin/system" icon={<ShieldCheck size={18} />} label="System Health" active={isActive('/admin/system')} />
        ...
        <div className="p-3 m-3 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
