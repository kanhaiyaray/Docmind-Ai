...
import {
  FileText, MessageSquare, Home, LayoutDashboard, Sparkles, Zap,
  BookOpen, History, Settings, LogOut, Plus, FolderOpen, BarChart3, Monitor,
} from 'lucide-react';
  ...
  return (
    <div className="sidebar">
      ...
      <div className="sidebar-nav">
        ...
        <SidebarItem to="/dashboard" icon={<Home className="h-4 w-4" />} label="Home" active={isActive('/dashboard')} />
        ...
        <SidebarItem to="/sessions" icon={<Monitor className="h-4 w-4" />} label="Sessions" active={isActive('/sessions')} />
      ...
      <div style={{ marginTop: 'auto', paddingTop: '16px', borderTop: '1px solid #eef0f3' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '8px 4px' }}>
          <div style={{
            ...
            justifyContent: 'center', color: 'white', fontWeight: 600, fontSize: '14px',
          }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{
              fontSize: '11px', color: '#a0a7b5',
              overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap',
            }}>
              {user?.email || 'user@example.com'}
            </div>
          </div>
          <button onClick={logout} style={{ padding: '4px', color: '#a0a7b5', background: 'none', border: 'none', cursor: 'pointer' }} aria-label="Logout">
